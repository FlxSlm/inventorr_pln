                ...
                <tr class="group-detail-row" data-parent="<?= $key ?>" data-status="<?= $filterClass ?>" style="display: none; background: var(--bg-secondary);">
                    ...
                    <td>
                        <div class="d-flex align-items-center gap-2" style="padding-left: 20px;">
                            <?php if ($item['inventory_image']): ?>
                            <img src="/public/assets/uploads/<?= htmlspecialchars($item['inventory_image']) ?>" alt="" style="width: 36px; height: 36px; object-fit: cover; border-radius: var(--radius);">
                            <?php else: ?>
                            <div style="width: 36px; height: 36px; background: var(--bg-main); border-radius: var(--radius); display: flex; align-items: center; justify-content: center;">
                                <i class="bi bi-box-seam" style="color: var(--text-muted); font-size: 14px;"></i>
                            </div>
                            <?php endif; ?>
                            <div>
                                <div style="font-weight: 500; font-size: 13px;"><?= htmlspecialchars($item['inventory_name']) ?></div>
                                <small style="color: var(--text-muted);"><?= htmlspecialchars($item['inventory_code']) ?></small>
                            </div>
                        </div>
                    </td>
                    <td><span style="font-weight: 600;"><?= $item['quantity'] ?></span></td>
                    <td colspan="4"></td>
                </tr>
                <?php endforeach; ?>
                <?php endif; ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label" style="font-weight: 600;">
                            <i class="bi bi-file-earmark-arrow-up me-1"></i>Upload Dokumen BAST (Berita Acara Serah Terima)
                        </label>
                    ...
                    <div class="alert alert-info mb-0">
                        ...
                        Dengan menyetujui, stok barang akan otomatis dikurangi dan notifikasi akan dikirim ke karyawan.
                    </div>
                </div>
                <div class="modal-footer">
