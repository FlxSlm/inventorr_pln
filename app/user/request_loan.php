...
$stmt = $pdo->query('SELECT id, name, code, stock_available, image, unit FROM inventories WHERE deleted_at IS NULL AND stock_available > 0 ORDER BY name ASC');
$items = $stmt->fetchAll();
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="itemSelect" class="form-select">
                                ...
                                <option value="<?= $it['id'] ?>" 
                                    ...
                                    <?= htmlspecialchars($it['name']) ?> (<?= htmlspecialchars($it['code']) ?>) - Stok: <?= $it['stock_available'] ?> <?= htmlspecialchars($it['unit'] ?? 'unit') ?>
                                </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
